 ...
 * 动态配置文件辅助类
 * 
 * @author zxc Nov 25, 2015 1:45:34 PM
 */
public class DynamicPropertiesHelper {
    ...
    protected static Logger                                         logger        = Logger.getLogger(DynamicPropertiesHelper.class);
    ...
    private Properties parse(String value) {
        ...
        if (!StringUtils.isEmpty(value)) try {
    ...
    public Long getLongProperty(String key, Long defaultValue) {
        ...
        try {
            ...
            logger.error("getLongProperty error!", e);
        }
        return retValue;
    }
    ...
    public Double getDoubleProperty(String key, Double defaultValue) {
        ...
        try {
            ...
            logger.error("getDoubleProperty error!", e);
        }
        return retValue;
    }
